                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div>
                            ...
                            <a href="mailto:chandru.k.26062005@gmail.com" className="text-base sm:text-lg md:text-xl tracking-wide hover:text-gray-300 transition-colors break-all">
                                {import.meta.env.VITE_CONTACT_EMAIL || "chandru.k.26062005@gmail.com"}
                            </a>
                        </div>

                        {/* Phone */}
                        <div>
                            <p className="text-gray-400 text-xs sm:text-sm mb-1 sm:mb-2">Phone:</p>
                            <a href="tel:+919345624126" className="text-base sm:text-lg md:text-xl tracking-wide hover:text-gray-300 transition-colors">
                                {import.meta.env.VITE_PHONE_NUMBER || "+91 9345624126"}
                            </a>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col items-center md:items-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                <a href="https://linkedin.com/in/chandru-k-67b2a8329/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" title="LinkedIn">
                                ...
                                <a href="https://github.com/CHANDRUK3" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" title="GitHub">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
